 ...
 * @author mountain
 */
public class SearchPlant extends javax.swing.JFrame {
    ...
    public SearchPlant() {
        ...
        jTextArea1.setText(fileIO.SpecialPlantPrint(ObjectList.specialPlantsList));        
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        SpecialPlants plant = fileIO.searchPlant(ObjectList.specialPlantsList, ID);
        ...
        if (plant != null)
        {
            plant.getDeathDate().setDeathDate(year, month, day);
