 ...
 * @author mountain
 */
public class SearchHuman extends javax.swing.JFrame {
    ...
    public SearchHuman() {
        ...
        jTextArea1.setText(fileIO.HumanPrint(ObjectList.humanList));
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Human human = fileIO.searchHuman(ObjectList.humanList, ID);
        ...
        if (human != null)
        {
            human.getBirthDate().setDeathDate(year, month, day);
