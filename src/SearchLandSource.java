 ...
 * @author mountain
 */
public class SearchLandSource extends javax.swing.JFrame {

    /**
     * Creates new form SearchHuman
     */
    public SearchLandSource() {
        initComponents();
        ObjectFileIO fileIO = new ObjectFileIO();
        jTextArea1.setText(fileIO.SpecialLandSourcePrint(ObjectList.specialLandSourceList));
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        SpecialLandSource landSource = fileIO.searchLandSource(ObjectList.specialLandSourceList, name);
        ...
        if (landSource != null)
        {
            landSource.getDeathDate().setDeathDate(year, month, day);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchHuman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
